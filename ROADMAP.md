...
| M16 | Connector Registry governado com mocks. | **Concluído como contrato interno**, sem credenciais reais nesta branch. | Registry allowlisted, manifest, capability, channel policy, estado habilitado, auditoria sanitizada e negativa de WRITE sem grant verificável testados; status textual não autoriza execução. |
